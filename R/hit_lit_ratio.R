dont_run <- function(shiny, ggplot2, hit_sec, as.numeric, as.Date, ride_duration_sec, total_duration_sec, week_load_total, week_load_hit, week_load_lit, hit_ratio, unique, variable, letters, value) {
  library(shiny)
  library(ggplot2)
